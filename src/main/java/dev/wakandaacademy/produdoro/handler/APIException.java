...
public class APIException extends RuntimeException {
	...
	public static APIException build(HttpStatus statusException, String massage) {
		return new APIException(statusException, massage, null);
	}
	public static APIException build(HttpStatus statusException, String massage, Exception e) {
		log.error("Exception: ", e);
		return new APIException(statusException, massage, e);
	}
