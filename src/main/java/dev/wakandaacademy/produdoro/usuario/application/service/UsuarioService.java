...
import dev.wakandaacademy.produdoro.credencial.application.service.CredencialAppicationService;
...
public class UsuarioService implements UsuarioApplicationService {
    ...
    private final CredencialAppicationService credencialService;
    private final UsuarioRepository usuarioRepository;

    @Override
    public UsuarioCriadoResponse criaNovoUsuario(@Valid UsuarioNovoRequest usuarioNovo) {
        log.info("[start] UsuarioService - criarNovoUsuario");
        ...
        log.info("[finish] UsuarioService - criarNovoUsuario");
